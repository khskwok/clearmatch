...
- **AI Integration**
  - Uses Microsoft Foundry for explanations (project: `khskw-mm8sjfq1-swedencentral_project`).
...
[Frontend (SPA)] --> [Azure Static Web App]
                     ...
                     +--> [API Functions (/api/reconcile, /api/explain)]
                          |
                          +--> [Microsoft Foundry (khskw-mm8sjfq1-swedencentral_project)]
```
...
- **Non-transparent Azure OpenAI resource policy**
  ...
  - Note: gpt-4o deployment requires quota approval; if unavailable, use gpt-4o-mini or DeepSeek-V3.2.
